...
const RAW = getData();   // bundled snapshot, or fresher copy set by loadRemote() at startup
const BIO = RAW.BIO || {};
const TEAM_BIO = RAW.TEAM_BIO || {};
const SHOTS = RAW.SHOTS || { LG: null, P: {} };   // null when fact_pbp is absent
