# Privacy Policy — Courtside

**Last updated: 2026-07-18**

Courtside is a free, ad-free WNBA statistics app published by an independent
fan developer. This policy explains what the app does and does not do with your
information. The short version: **it collects nothing.**
...
The app collects no data from anyone, including children under 13, and is safe
for all ages in that respect.

## Data source and attribution

The statistics shown in the app are derived from publicly available WNBA game
data and are bundled into the app when it is built. No user data is involved in
producing them.
